  ...
  return (
    <main>
      ...
      <section className="grid md:grid-cols-2 gap-8 px-8 py-12 border-b border-black">
        <div>
          <h1 className="text-4xl mb-4">Foundation</h1>
          <p className="mb-6 text-lg">
            Learn the craft. Build your confidence. Get grounded in the
            essentials of barbering — from tool handling and cutting techniques
            to understanding face shapes, fades, and client service. This is
            where you learn the language of the trade.
          </p>
