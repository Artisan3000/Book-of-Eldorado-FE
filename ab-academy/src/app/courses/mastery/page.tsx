...
export default function FinishingCoursePage() {
  ...
  return (
    <main>
      ...
      <section className="grid md:grid-cols-2 gap-8 px-8 py-12 border-b border-black">
        <div>
          <h1 className="text-4xl mb-4">Mastery</h1>
        ...
        {activeTab === "Curriculum" && (
          <>
            ...
            <ol className="list-decimal list-inside space-y-4">
              ...
              <li>
                <strong>
                  Mentorship & Apprenticeship Transition (4 weeks)
                </strong>
                <p>
        ...
        {activeTab === "Testimonials" && (
          <>
            ...
            <blockquote className="italic mb-4">
              ...
              like a brand.”
              <span className="block font-bold mt-2">— Jordan, New York</span>
            </blockquote>
          </>
        )}
      </section>
